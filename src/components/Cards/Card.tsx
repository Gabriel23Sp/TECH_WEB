...
const Card:FC<CardProps> = ({img}) => {
  return (
    <div className='block-card bg-white text-black m-2 rounded-md'>
      ...
      <div className='button-card m-2 border-blue-500 border-[1px] rounded-md w-[200px] hover:bg-blue-500 hover:text-white transition-all text-blue-500 cursor-pointer'>
        <button className='mx-[20px] my-[10px]'>Solicitar Informacion</button>
      </div>
      </div>
    </div>
  )
